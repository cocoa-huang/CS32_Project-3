...
int main()
{
    ...
    cout << "  3.  A " << NTRIALS
         ...
         << endl;
    cout << "  4.  A awful player against a human player" << endl;
    cout << "  5.  A " << NTRIALS
         << "-game match between a mediocre player and a good player, with no pauses"
         << endl;
    ...
    else if (line[0] == '3')
    {
        ...
        for (int k = 1; k <= NTRIALS; k++)
        {
            ...
            Player* p2 = createPlayer("good", "Good Golden", g);
            Player* winner = (k % 2 == 1 ?
                                g.play(p1, p2, false) : g.play(p2, p1, false));
            if (winner == p2)
                nGoodWins++;
